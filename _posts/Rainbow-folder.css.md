...
modified: 2024-08-24T23:09:15-04:00
tags:
  - obsidian
  - notes
  - css
...
category:
  ...
  - customizing
layout: post
title: "CSS Code Snippet for Rainbow Folders in Obsidian"
summary: "CSS Code Snippet for Obsidian to have rainbow colored folders based on the folder name"
author: Yohn
date: 2024-08-24 22:54
thumbnail: /assets/img/posts/rainbow-css.png
preview: /assets/img/posts/rainbow-css.png
keywords: obsidian, notes, css, styling, rainbow, folders, classes, stylesheet, snippets, code, php, customizing
usemathjax: false
...
Below is the slightly modified CSS code to have  rainbow style folder colors names within your obsidian note.

```css
/*------------------------------------------------------------------------------
               Obsidian Colored Sidebar Items by CyanVoxel v2.0.1
...
Modified by Yohn, to add 00-15 colored folders
------------------------------------------------------------------------------*/

:root {
  /* ================================ Colors ================================ */
  --red: #e22c3c;                /* Default Prefix: 00 */
  --red-orange: #e9404b;         /* Default Prefix: 01 */
  --orange: #ee6748;             /* Default Prefix: 02 */
  --amber: #fa9f50;              /* Default Prefix: 03 */
  --yellow: #ffd85e;             /* Default Prefix: 04 */
  --lime: #97e768;               /* Default Prefix: 05 */
  --mint: #52eea3;               /* Default Prefix: 06 */
  --cyan: #51e1e9;               /* Default Prefix: 07 */
  --cool-cyan: #43cfea;          /* Default Prefix: 08 */
  --light-blue: #54b6f8;         /* Default Prefix: 09 */
  --blue: #437cf3;               /* Default Prefix: 10 */
  --blue-violet: #6f51f4;        /* Default Prefix: 11 */
  --violet: #9446f8;             /* Default Prefix: 12 */
  --purple: #c952ed;             /* Default Prefix: 13 */
  --magenta: #e54f9b;            /* Default Prefix: 14 */
...
.nav-folder-title[data-path^="01"] {
  ...
  --nav-collapse-icon-color: color-mix(in srgb, var(--orange) 60%, transparent);
}
...
.nav-folder-title[data-path^="07"] {
  ...
  --nav-item-color-hover: color-mix(
    in srgb,
    var(--cool-cyan) var(--fg-contrast-amount),
    var(--contrast-color)
  );
  --nav-item-background-hover: color-mix(
    in srgb,
    var(--cool-cyan) var(--bg-contrast-amount),
    transparent
  );
  --background-modifier-border-focus: color-mix(
    in srgb,
  ...
  --nav-collapse-icon-color: color-mix(in srgb, var(--cool-cyan) 60%, transparent);
}
...
.tree-item-children .nav-folder:has(.nav-folder-title[data-path^="07"]) {
  --nav-indentation-guide-color: color-mix(
    in srgb,
    var(--cool-cyan) var(--medium-contrast-amount),
    transparent
  );
}
.tree-item-children
  ...
  --nav-item-background-hover: color-mix(
    in srgb,
    color-mix(in srgb, var(--cool-cyan) 50%, var(--highlight))
      var(--bg-contrast-amount),
    transparent
  );
  --background-modifier-border-focus: color-mix(
  ...
  --nav-item-background-active: color-mix(
    in srgb,
    var(--cool-cyan) var(--active-contrast-amount),
    transparent
  );
}
/* ------------------------------- 08 Prefix -------------------------------- */
.nav-folder-title[data-path^="08"] {
  ...
  --nav-collapse-icon-color: color-mix(in srgb, var(--light-blue) 60%, transparent);
}
...
.nav-folder-title[data-path^="10"] {
  ...
  --nav-item-color-hover: color-mix(
    in srgb,
    var(--blue-violet) var(--fg-contrast-amount),
    var(--contrast-color)
  );
  --nav-item-background-hover: color-mix(
    in srgb,
    var(--blue-violet) var(--bg-contrast-amount),
    transparent
  );
  --background-modifier-border-focus: color-mix(
    in srgb,
  ...
  --nav-collapse-icon-color: color-mix(in srgb, var(--blue-violet) 60%, transparent);
}
...
.tree-item-children .nav-folder:has(.nav-folder-title[data-path^="10"]) {
  --nav-indentation-guide-color: color-mix(
    in srgb,
    var(--blue-violet) var(--medium-contrast-amount),
    transparent
  );
}
.tree-item-children
  ...
  --nav-item-background-hover: color-mix(
    in srgb,
    color-mix(in srgb, var(--blue-violet) 50%, var(--highlight))
      var(--bg-contrast-amount),
    transparent
  );
  --background-modifier-border-focus: color-mix(
  ...
  --nav-item-background-active: color-mix(
    in srgb,
    var(--blue-violet) var(--active-contrast-amount),
    transparent
  );
}
/* ------------------------------- 11 Prefix -------------------------------- */
...
.nav-folder-title[data-path^="13"] {
  ...
  --nav-collapse-icon-color: color-mix(in srgb, var(--magenta) 60%, transparent);
}
...
.nav-folder-title[data-path^="14"] {
  ...
  --nav-collapse-icon-color: color-mix(in srgb, var(--hot-red) 60%, transparent);
}
